let allAdidasShoes = []; // Adidas cipők tömbje
...
document.addEventListener("DOMContentLoaded", function() {
  fetch("http://localhost:5000/api/cipok?marka=Adidas")
    ...
    .then(data => {
      allAdidasShoes = data; // Mentés a megfelelő változóba
      console.log("✅ Betöltött Adidas cipők:", allAdidasShoes); // Debug

      renderShoes(allAdidasShoes); // Kirajzolás
    })
    .catch(error => {
  ...
  document.getElementById("sortSelect").addEventListener("change", function() {
    ...
    if (value === "asc") {
      ...
      allAdidasShoes.sort((a, b) => b.ar - a.ar);
    }
